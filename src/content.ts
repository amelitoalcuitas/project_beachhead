...
// Splash uses separate infantry tuning so Bofors direct hits stay unchanged.
export const splashEffectiveness: Record<Weapon, Record<EnemyType, number>> = {
  MG: { ...weaponEffectiveness.MG },
  CANNON: {
    ...weaponEffectiveness.CANNON,
    infantry: 1,
    armoredInfantry: 0.85,
    grenadierInfantry: 1,
  },
  BOFORS: {
    ...weaponEffectiveness.BOFORS,
    infantry: 0.35,
    armoredInfantry: 0.35,
    grenadierInfantry: 0.35,
  },
};
